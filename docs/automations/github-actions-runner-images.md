...
This weekly automation keeps Focaccia workflow runner labels aligned with
...
```sh
gh ruleset list --repo artichoke/focaccia
gh api repos/artichoke/focaccia/rulesets/RULESET_ID \
