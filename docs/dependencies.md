...
Focaccia keeps dependency surfaces small, pinned, and auditable. Every
...
- The Unicode maintenance automation owns Unicode case-folding data, the Unicode
  license, and generated folding tables.
