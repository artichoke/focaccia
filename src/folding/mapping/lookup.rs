...
//
// Last generated on 2026-08-31 00:04:50 UTC.
//
// Unicode version:
...
pub const fn lookup(c: char, mode: Mode) -> Mapping {
    ...
    match (high_bytes, mid_byte) {
        ...
        (0x0000, 0xA7) => match c {
            ...
            '\u{A7CB}' => Mapping::Single(0x0264),
            '\u{A7CC}' => Mapping::Single(0xA7CD),
            '\u{A7CE}' => Mapping::Single(0xA7CF),
            '\u{A7D0}' => Mapping::Single(0xA7D1),
            '\u{A7D2}' => Mapping::Single(0xA7D3),
            '\u{A7D4}' => Mapping::Single(0xA7D5),
            '\u{A7D6}' => Mapping::Single(0xA7D7),
            '\u{A7D8}' => Mapping::Single(0xA7D9),
            '\u{A7DA}' => Mapping::Single(0xA7DB),
            '\u{A7DC}' => Mapping::Single(0x019B),
        ...
        (0x0001, 0x0D) => match c {
            '\u{10D50}'..='\u{10D65}' => Mapping::Single(codepoint + 0x0020),
            _ => Mapping::Single(codepoint),
        },
        (0x0001, 0x18) => match c {
        ...
        (0x0001, 0x6E) => match c {
            ...
            '\u{16EA0}'..='\u{16EB8}' => Mapping::Single(codepoint + 0x001b),
            _ => Mapping::Single(codepoint),
        },
        (0x0001, 0xE9) => match c {
