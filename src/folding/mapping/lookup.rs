...
//
// Last generated on 2020-12-16 02:12:41 UTC.
//
// Unicode version:
...
pub fn lookup(c: char, mode: Mode) -> Mapping {
    ...
    match (high_bytes, mid_byte) {
        ...
        (0x0000, 0x01) => match c {
            ...
            '\u{0189}'..='\u{018A}' => Mapping::Single(u32::from(c).wrapping_add(0x00cd)),
            ...
            '\u{01B1}'..='\u{01B2}' => Mapping::Single(u32::from(c).wrapping_add(0x00d9)),
        ...
        (0x0000, 0x03) => match c {
            ...
            '\u{0388}'..='\u{038A}' => Mapping::Single(u32::from(c).wrapping_add(0x0025)),
            '\u{038C}' => Mapping::Single(0x03CC),
            '\u{038E}'..='\u{038F}' => Mapping::Single(u32::from(c).wrapping_add(0x003f)),
            '\u{0390}' => Mapping::Triple(0x03B9, 0x0308, 0x0301),
            '\u{0391}'..='\u{03A1}' => Mapping::Single(u32::from(c).wrapping_add(0x0020)),
            '\u{03A3}'..='\u{03AB}' => Mapping::Single(u32::from(c).wrapping_add(0x0020)),
        ...
        (0x0000, 0x04) => match c {
            ...
            '\u{0410}'..='\u{042F}' => Mapping::Single(u32::from(c).wrapping_add(0x0020)),
        ...
        (0x0000, 0x1C) => match c {
            ...
            '\u{1C83}'..='\u{1C84}' => Mapping::Single(u32::from(c).wrapping_sub(0x1842)),
        ...
        (0x0000, 0x1F) => match c {
            ...
            '\u{1F18}'..='\u{1F1D}' => Mapping::Single(u32::from(c).wrapping_sub(0x0008)),
            '\u{1F28}'..='\u{1F2F}' => Mapping::Single(u32::from(c).wrapping_sub(0x0008)),
            '\u{1F38}'..='\u{1F3F}' => Mapping::Single(u32::from(c).wrapping_sub(0x0008)),
            '\u{1F48}'..='\u{1F4D}' => Mapping::Single(u32::from(c).wrapping_sub(0x0008)),
            ...
            '\u{1F68}'..='\u{1F6F}' => Mapping::Single(u32::from(c).wrapping_sub(0x0008)),
            '\u{1F80}'..='\u{1F87}' => Mapping::Double(u32::from(c).wrapping_sub(0x0080), 0x03B9),
            '\u{1F88}'..='\u{1F8F}' => Mapping::Double(u32::from(c).wrapping_sub(0x0088), 0x03B9),
            '\u{1F90}'..='\u{1F97}' => Mapping::Double(u32::from(c).wrapping_sub(0x0070), 0x03B9),
            '\u{1F98}'..='\u{1F9F}' => Mapping::Double(u32::from(c).wrapping_sub(0x0078), 0x03B9),
            '\u{1FA0}'..='\u{1FA7}' => Mapping::Double(u32::from(c).wrapping_sub(0x0040), 0x03B9),
            '\u{1FA8}'..='\u{1FAF}' => Mapping::Double(u32::from(c).wrapping_sub(0x0048), 0x03B9),
            ...
            '\u{1FB8}'..='\u{1FB9}' => Mapping::Single(u32::from(c).wrapping_sub(0x0008)),
            '\u{1FBA}'..='\u{1FBB}' => Mapping::Single(u32::from(c).wrapping_sub(0x004a)),
            ...
            '\u{1FC8}'..='\u{1FCB}' => Mapping::Single(u32::from(c).wrapping_sub(0x0056)),
            ...
            '\u{1FD8}'..='\u{1FD9}' => Mapping::Single(u32::from(c).wrapping_sub(0x0008)),
            '\u{1FDA}'..='\u{1FDB}' => Mapping::Single(u32::from(c).wrapping_sub(0x0064)),
            ...
            '\u{1FE8}'..='\u{1FE9}' => Mapping::Single(u32::from(c).wrapping_sub(0x0008)),
            '\u{1FEA}'..='\u{1FEB}' => Mapping::Single(u32::from(c).wrapping_sub(0x0070)),
        ...
        (0x0000, 0x2C) => match c {
            ...
            '\u{2C7E}'..='\u{2C7F}' => Mapping::Single(u32::from(c).wrapping_sub(0x2a3f)),
